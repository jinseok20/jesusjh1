...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* getTime() : 1970년 1월 1일 00시00분00초를 지난시간을 millisecond로 계산해서 long타입으로 반환한다. */

        System.out.println("today.getTime() = " + today.getTime()); //1712127097264
        Date time = new Date(1712127097264L);
