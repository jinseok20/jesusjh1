...
public class Application1 {
    public static void main(String[] args) {
        ...
        /*
        * 상황에 따라 기본 타입의 데이터를 인스턴스화해야 하는 경우가 발생한다.
        ...
        * 기본 타입을 레퍼런스의 인스턴스로 인스턴스화 하는것을 박싱이라고 하며
        * 레퍼클래스 타입의 인스턴스를 기본타입으로 변경하는 것을 언박싱이라고 한다.
        * */
        ...
        * */
        ...
        System.out.println("equals = " + (integerNum2.equals(integerNum3)));    //true
